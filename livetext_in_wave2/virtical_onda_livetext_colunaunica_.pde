...
void renderWave() {
  ...
  //  for (int y = xspacing*3; y < width - xspacing*3; y+= xspacing) {
      ...
      if (x == 16) {
        ...
        text(word0, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 15) {
        String word1 = words.get(1);
        text(word1, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 14) {
        String word2 = words.get(2);
        text(word2, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 13) {
        String word3 = words.get(3);
        text(word3, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 12) {
        String word4 = words.get(4);
        text(word4, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 11) {
        String word5 = words.get(5);
        text(word5, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 10) {
        String word6 = words.get(6);
        text(word6, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 9) {
        String word7 = words.get(7);
        text(word7, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 8) {
        String word8 = words.get(8);
        text(word8, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 7) {
        String word9 = words.get(9);
        text(word9, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 6) {
        String word10 = words.get(10);
        text(word10, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 5) {
        String word11 = words.get(11);
        text(word11, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 4) {
        String word12 = words.get(12);
        text(word12, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 3) {
        String word13 = words.get(13);
        text(word13, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 2) {
        String word14 = words.get(14);
        text(word14, yvalues[x]+width/2, height - x*xspacing);
      }
      if (x == 1) {
        String word15 = words.get(15);
        text(word15, yvalues[x]+width/2, height - x*xspacing);
 //     }
    }
  }
}
